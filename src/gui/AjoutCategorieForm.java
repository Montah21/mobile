     ...
     TextField Quantite = new TextField("","entrer quantite");
        ...
        btnAjouter.addActionListener((e)->{
            try {
                ...
                if(Libelle.getText().equals("") || Quantite.getText().equals("")) {
                    ...
                    Categorie c = new Categorie(Libelle.getText(), Integer.parseInt(Quantite.getText()));
                    ...
                    CategorieServices.getInstance().ajouterCategorie(c);                    
